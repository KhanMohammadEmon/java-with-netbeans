...
public class JavaLecture19 implements WindowListener, ActionListener, MouseMotionListener,MouseListener { private Frame f = new Frame("My_Frame With Menu");
  ...
  // private  TextField  textField = new TextField(50);
   public  void show()
    ...
    public static void main(String[] args) {
       JavaLecture19 abc = new JavaLecture19();
       abc.show();
    }
